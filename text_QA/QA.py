...
def ui_game(ui_text):
    ...
    return ui_game
#询问内容交互
def ui_YourExperience(name,background,game_Experience):
    global change_language
    ui_Experience = "我们来玩一个角色扮演游戏,假装你是知名程序员"+name+",你曾经:"+background+"你有什么关于"+game_Experience+"的分享?回答控制在100字以内,只用"+change_language+"回答"        
